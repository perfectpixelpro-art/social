...
export default function BarPricingSection() {
  const plans = [
    {
      name: "Starter",
      price: "$99",
  ...
  return (
    <section className="py-[40px] md:py-[60px] lg:py-[60px]">
      <div
        className="
          max-w-[1440px]
          mx-auto
      ...
      >
        ...
        <div className="text-center max-w-[1100px] mx-auto">
          ...
          <p
            ...
            "
          >
            No long onboarding. No waiting weeks to begin. If it's<br/> not the right fit, cancel anytime
          </p>
        </div>
