  ...
  return (
    <div className="w-full font-[Montserrat] overflow-x-hidden">
      ...
      >
        <div className="w-full px-[100px] mq800:px-10 mq450:px-5 py-24  mq450:py-0 flex justify-center">
          <div className="relative w-full max-w-[1300px] flex items-center justify-center" style={{ minHeight: "clamp(380px, 50vw, 560px)" }}>
            ...
            {/* Floating feature badges — only on wide desktop so they never clip */}
            {badges.map((b) => (
              <div
                key={b.label}
                className="absolute hidden xl:flex items-center gap-2 bg-white rounded-full shadow-[0_4px_20px_rgba(1,49,134,0.12)] px-4 py-2"
            ...
            <div className="relative z-10 flex flex-col items-center text-center">
              ...
              {/* Wrapped chips — below xl */}
              <div className="flex xl:hidden flex-wrap items-center justify-center gap-2 mt-8 max-w-[560px]">
                {badges.map((b) => (
      ...
      <div className="w-full px-[100px] mq800:px-10 mq450:px-5 mq450:py-10 py-16 flex justify-center">
        ...
        >
          <div className="relative flex items-center justify-center min-h-[360px] py-16 xl:py-0 xl:aspect-[1600/620]">

            {/* Concentric circles — only on wide desktop */}
            <svg className="absolute inset-0 w-full h-full pointer-events-none hidden xl:block" viewBox="0 0 1600 620" preserveAspectRatio="xMidYMid meet">
              {[120, 220, 320, 430].map((r) => (
                <circle key={r} cx="800" cy="310" r={r} fill="none" stroke="rgba(1,49,134,0.06)" strokeWidth="1.5" />
              ))}
            </svg>

            {/* Floating tech badges — only on wide desktop so they never clip */}
            {techBadges.map((b) => (
              <div
                key={b.label}
                className="absolute hidden xl:flex items-center gap-2 bg-white rounded-full shadow-[0_4px_20px_rgba(1,49,134,0.12)] px-4 py-2"
