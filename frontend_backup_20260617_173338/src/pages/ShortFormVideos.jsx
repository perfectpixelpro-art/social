      ...
      >
        <div className="w-full px-[100px] mq800:px-10 mq450:px-5 py-24 mq450:py-14 flex justify-center">
          <div className="relative w-full max-w-[1300px] flex items-center justify-center" style={{ minHeight: "clamp(420px, 52vw, 620px)" }}>
            ...
            <svg className="absolute inset-0 w-full h-full pointer-events-none hidden xl:block" viewBox="0 0 1300 620" preserveAspectRatio="xMidYMid meet">
            ...
            {avatars.map((a, i) => (
              <div
                key={i}
                className="absolute hidden xl:block w-[56px] h-[56px] rounded-full overflow-hidden border-2 border-white shadow-[0_4px_16px_rgba(1,49,134,0.18)]"
