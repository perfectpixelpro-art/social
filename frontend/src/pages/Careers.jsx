...
export default function Careers() {
  ...
  return (
    <div className="w-full font-[Montserrat] overflow-x-hidden">
      <Seo path="/careers" title="Careers at The Social 99 - Join Our Team" description="Join The Social 99. Explore career opportunities in social media, content creation, video editing, and design with a fast-growing agency." breadcrumbs={[{ name: "Home", path: "/" }, { name: "Careers", path: "/careers" }]} />
