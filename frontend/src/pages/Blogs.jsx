...
export default function Blogs() {
  return (
    <div className="w-full font-[Montserrat] overflow-x-hidden">
      <Seo path="/blogs" title="Blog - Social Media Marketing Tips | The Social 99" description="Actionable social media marketing tips, content strategy, and growth insights for small businesses from The Social 99." breadcrumbs={[{ name: "Home", path: "/" }, { name: "Blog", path: "/blogs" }]} />
      {/* Hero */}
