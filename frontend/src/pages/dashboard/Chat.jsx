  ...
  return (
    <div className="h-full flex flex-col min-h-0 relative"
      ...
      <div className="h-[72px] shrink-0 border-b border-[#eef1f6] flex items-center gap-3 px-6 mq450:px-4">
        ...
        <button type="button" onClick={() => setShowSchedule(true)} title="Schedule Zoom meeting"
          className="ml-auto flex items-center gap-2 rounded-[10px] border border-[#cfe0ff] bg-[#f0f6ff] text-[#2D8CFF] hover:bg-[#e3eeff] px-3 py-2 cursor-pointer font-bold text-[13px]">
          ...
          <span className="mq450:hidden">Schedule Zoom</span>
        </button>
      </div>
