...
const Services = () => {
  return (
    <div className="w-full px-[100px] mq800:px-10 mq450:px-5 py-20">
      <Seo path="/services" title="Our Services - Social Media, Video & Web Design | The Social 99" description="Explore The Social 99's services: social media management, short-form video creation, and conversion-focused website design for small businesses from $99/month." breadcrumbs={[{ name: "Home", path: "/" }, { name: "Services", path: "/services" }]} />
